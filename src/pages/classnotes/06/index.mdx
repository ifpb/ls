...
[hello-js/index.html](/codes/bom/hello-js/index.html):

<Code src="/codes/bom/hello-js/index.html" lang="markup" />

[hello-js/js/index.js](/codes/bom/hello-js/js/index.js):

<Code src="/codes/bom/hello-js/js/index.js" lang="js" />
...
![](/imgs/classnotes/06/dom-hierarchy.svg)
...
```
export const handleAlert = () => alert('Hello world!')
...
```
export const handleConfirm = () => console.log(confirm('Is this JavaScript?'))
...
export const handlePrompt = () => console.log(prompt('What is your name?'))
...
![](/imgs/classnotes/06/console-table-fruits.png)
