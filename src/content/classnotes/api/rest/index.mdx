...
[REST Client](https://marketplace.visualstudio.com/items?itemName=humao.rest-client) ([Código Fonte](https://github.com/ifpb/ls/tree/main/public/codes/api/rest/)):
...
[Código Fonte das requisições (Rest Client)](https://github.com/ifpb/ls/tree/main/public/codes/api/rest/)
